# AUTOGENERATED! DO NOT EDIT! File to edit: data-processing-eda.ipynb (unless otherwise specified).

__all__ = ['describe', 'aggregate_features']
...
def describe(df):
    ...
    # percent missing
    dqr_percent_missing = pd.DataFrame(100 * (df.isnull().sum() / len(df)).round(4), columns=['% Missing'])
